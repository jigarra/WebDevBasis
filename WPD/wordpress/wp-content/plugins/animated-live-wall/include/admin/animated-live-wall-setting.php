					...
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								...
								<p><?php esc_html_e( 'Enter access token to add the Instagram feed. You can generate access token easily from here', 'animated-live-wall' ); ?> <a target="_blank" href="https://awplife.com/instagram-access-token-generator/"><?php esc_html_e( 'pixelunion', 'animated-live-wall' ); ?></a></p> 
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field panel-body">
								...
								if ( isset( $alw_get_settings['alw_instagram_token'] ) ) {
									...
									$alw_instagram_token = '10925106910.1677ed0.ee317ab70ae04d60bfdaf95e6f934cf3';
								}
								?>
